                ...
                <div className="w-[80%] mx-auto py-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    >
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm mb-1">Our friendly team is here to help.</p>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm mb-1">Come say hello at our HQ.</p>
                                    <p className="text-slate-900">123 Tech Park, Silicon Valley, CA</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-sm mb-1">Mon-Fri from 8am to 5pm.</p>
                        ...
                        <div className="mt-12 p-6 bg-slate-50 rounded-xl border border-slate-100">
                            <h4 className="font-medium text-slate-900 mb-2">Response Time Commitment</h4>
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="first-name" className="w-full px-4 py-3 rounded-lg bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition" placeholder="John" />
                                </div>
                                <div>
