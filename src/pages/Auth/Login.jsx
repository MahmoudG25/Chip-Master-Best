...
const Login = () => {
    return (
      <>
        <Navbar />
        <main className="w-full min-h-[calc(100vh-100px)] flex items-center justify-center py-12 bg-gray-50">
            <div className="w-[85%] max-w-6xl mx-auto flex bg-white rounded-3xl shadow-xl overflow-hidden min-h-[600px]">
                {/* Left Side - Image */}
                ...
                <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8 md:p-12">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <div className="space-y-4">
                            <button type="button" className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 hover:bg-gray-50 transition-colors h-12 rounded-xl text-gray-700 font-medium">
